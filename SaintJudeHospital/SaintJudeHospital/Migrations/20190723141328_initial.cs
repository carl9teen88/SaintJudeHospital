        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PPDFee = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    FollowUpFee = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    EarPiercingFee = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    NebulizationFee = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 94, "Osmotic Fragility" },
                    { 90, "Peripheral Smear" },
                    { 91, "Platelet Count(Plt.Ct.)" },
                    { 92, "* Phosphorus(Inorg)" },
                    { 93, "Newborn Screening(NBS)" },
                    { 137, "Tuberculosis Ab(TB Ab)" },
                    { 100, "Malarial Smear" },
                    { 96, "* Parathyroid Hormone(PTH)" },
                    { 97, "Pleural Routine" },
                    { 98, "Potassium(Blood K +)" },
                    { 99, "Occult Blood" },
                    { 89, "Potassium(Urine K +)" },
                    { 101, "* Testosterone" },
                    { 95, "Pap smear w / check up" },
                    { 88, "Pregnancy Test(PT)" },
                    { 82, "Glycosylated Hemoglobin(HbA1C)" },
                    { 86, "* HBsAg(EIA)" },
                    { 72, "Hematocrit(Hct)" },
                    { 73, "Gonorrhea w / Check - up" },
                    { 74, "* Lactate Dehydrogenase(LDH)" },
                    { 75, "L.E.Preparation" },
                    { 76, "Lipid Profile" },
                    { 77, "Liver Profile" },
                    { 87, "* HBeAg" },
                    ...
                    { 110, "Stool Exam(S / E)" },
                    { 105, "Thyroxine(T4)" },
                    { 71, "Hemoglucotest(HGT)" },
                    { 136, "* Troponin T(Trop.T)" },
                    { 135, "* Troponin I(Trop.I)" },
                    { 134, "Urinalysis(U / A)" },
                    { 133, "VDRL" },
                    { 132, "* Urobilinogen" },
                    { 131, "White Blood Cell Count(WBC Ct.)" },
                    { 130, "Uric Acid(Urine" },
                    { 129, "Widal 5 Ags" },
                    { 128, "White Blood Cell Differential Count(WBC Diff.Count)" },
                    { 127, "Thphidot" },
                    { 126, "Wet Mount" },
                    { 125, "PTPA - Protime / Prothrombin Time" },
                    { 124, "Semen Analysis" },
                    { 123, "* Total CPK NAC" },
                    { 122, "Total Protein(TP)" },
                    { 121, "TPHA" },
                    { 106, "SGOT / ASAT" },
                    { 107, "Random Blood Sugar(RBS)" },
                    { 108, "SGPT / ALAT" },
                    { 109, "* Rheumatoid Factor(RA / RF)" },
                    { 111, "Sodium(Urine Na +)" },
                    { 112, "Sodium(Blood Na +)" },
                    { 104, "Thyroid - stimulating Hormone(TSH)" },
                    { 113, "* Progesterone" },
                    { 115, "* Prolcatin" },
                    { 116, "* Prostate - Specific Ag(PSA Quantitative)" },
                    { 117, "Protein Albumin(Urine)" },
                    { 118, "Reticulocyte Count(Retic.Ct.)" },
                    { 119, "Triiodothyronine(T3)" },
                    { 120, "Triglycerides" },
                    { 114, "Prostate - Specific Ag(PSA Qualitative)" },
                    { 70, "KOH" },
                    { 43, "* C - Reactive Protein(CRP)" },
                    { 68, "Hepatitis B Profile" },
                    { 31, "Blood Indices" },
                    { 30, "Blood Urea Nitrogen(BUN)" },
                    { 29, "* Biopsy(Small)" },
                    { 28, "Biliribin - Direct / Indirect(DB / IB)" },
                    { 27, "* Beta - HCG(Blood)" },
                    { 26, "Beta - HCG / Dilution(Urine)" },
                    { 25, "* Anti - HBs Titer" },
                    { 24, "* Anti - HBs(Semi - QUanti)" },
                    { 23, "* Anti - HCV EIA" },
                    { 22, "* Anti - H.Pylori" },
                    { 21, "* Anti - HCV(Screening)" },
                    { 20, "* Anti - streptolysin O Titer(ASO Titer)" },
                    { 19, "* Anti - HBc Total" },
                    { 18, "* Anti - HBe" },
                    { 17, "* Anti - Hav Total" },
                    { 16, "* Anti - HBc lgM" },
                    { 69, "Ketones" },
                    { 1, "75 gms.OGTT" },
                    { 2, "Acid Fast Bacili Staining(AFB)" },
                    { 3, "24 Urine Cortisol" },
                    { 4, "50 gms.OGTT" },
                    ...
                    { 10, "Acid Phosphatase(Prostatic ACP)" },
                    { 11, "100 gms.OGTT" },
                    { 12, "Albumin / Globulin(Alb / Glob)" },
                    { 13, "* ANA(Screening and Panel)" },
                    { 14, "* Anti - HAV lgM" },
                    { 8, "2 HPPBS" },
                    { 33, "* Biopsy(Lagre)" },
                    { 15, "Alkaline Phosphatase(ALP)" },
                    { 35, "Blood Uric Acid(BUA)" },
                    { 34, "Bilirubin - Total(TB)" },
                    { 67, "Eosinophils" },
                    { 66, "Fasting Blood Sugar(FBS)" },
                    { 65, "Clotting Time - Bleeding Time(CT - BT)" },
                    { 64, "* Ferritin" },
                    { 63, "Gamma - GT(GGT)" },
                    { 62, "* Free Triiodothyronine(FT3)" },
                    { 60, "* Estradiol" },
                    { 59, "Erythrocyte Sedimentation Rate(ESR)" },
                    { 58, "* DsDNA" },
                    { 57, "Dengue NS1 Ag" },
                    { 56, "Creatinine(Blood)" },
                    { 55, "Cholinesterase - RBC" },
                    { 54, "Cholesterol(HDL / VLD / LDL)" },
                    { 53, "Cholesterol - Total" },
                    { 61, "Free Thyroxine(FT4)" },
                    { 51, "Chloride(CI -)" },
                    { 36, "* C3 700 - W / I" },
                    { 52, "Chlamydia w / Check - up" },
                    { 37, "* Carcino - embryonic Ag(CEA)" },
                    { 38, "Calcium(Urine Ca++)" },
                    { 39, "* C4 750 - W / I" },
                    { 41, "* CA 15.3" },
                    { 42, "* CA 125" },
                    ...
                    { 44, "Calcium(Blood Ca++)" },
                    { 45, "* Cortisol" },
                    { 46, "* Cholinesterase - Serum" },
                    { 47, "Complete Blood Count(CBC)" },
                    { 48, "* Creatine Kinase(CK - MB)" },
                    { 49, "Creatinine Total(Urine)" },
                    { 50, "Cerebrospinal Fluid Routine(CSF)" }
                });
